...
You can download the data used in this project from the following link:
- **MalwarePix-small** : [Download Data from Google Drive](https://drive.google.com/drive/folders/1d6pnDUoJt7tDYyCFxDcDiTYa-2TdVn7N)
- **MalwarePix-medium** :
-  **MalwarePix-large** :
